function [] = plotRvsAngle(wl, layers, lam0, lam1, angle, thicknesses, R, polarization, directory)
...
%% Setup titles
        ...
        % Put it all together
        plotTitle = {['Reflectivity with ' pol '-polarization'], ['Layers: ' stack], note, ' '};
        ...
        saveTitle = ['Reflectivity with ' pol '-polarization ', saveStack, ', ' note];
    ...
    for q = 1:length(angle)
        scatter(wl, R(:,q),(100+20*(q-1)), 'filled');
    end
