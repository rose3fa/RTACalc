function [] = plotAvsAngle(wl, layers, lam0, lam1, angle,thicknesses, A, polarization, directory)
...
% Create title text
        ...
        % Put it all together
        plotTitle = {['Absorptivity with ' pol '-polarization'], ['Layers: ' stack], note, ' '};
        ...
        saveTitle = ['Absorptivity with ' pol '-polarization ', saveStack, ', ' note];
    ...
    for q = 1:length(angle)
        scatter(wl, A(:,q),(100+20*(q-1)), 'filled');
    end
